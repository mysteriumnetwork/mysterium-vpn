...
class CodeAuthorizationRequest {
  ...
  final CodeAuthorizationRequestCodeChallengeMethodEnum codeChallengeMethod;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is CodeAuthorizationRequest &&
  ...
  factory CodeAuthorizationRequest.fromJson(Map<String, dynamic> json) => _$CodeAuthorizationRequestFromJson(json);

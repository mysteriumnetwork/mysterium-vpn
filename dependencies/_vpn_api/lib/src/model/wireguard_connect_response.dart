...
class WireguardConnectResponse {
  ...
  final bool? limitExceeded;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is WireguardConnectResponse &&
  ...
  factory WireguardConnectResponse.fromJson(Map<String, dynamic> json) => _$WireguardConnectResponseFromJson(json);

...
class CreateGoogleSubscriptionResponse {
  ...
  final String subscriptionProductId;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is CreateGoogleSubscriptionResponse &&
  ...
  factory CreateGoogleSubscriptionResponse.fromJson(Map<String, dynamic> json) => _$CreateGoogleSubscriptionResponseFromJson(json);

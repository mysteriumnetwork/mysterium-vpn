...
class SubscriptionConfigResponsePlansInner {
  ...
  final List<String> supportedGateways;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is SubscriptionConfigResponsePlansInner &&
      other.id == id &&
  ...
  factory SubscriptionConfigResponsePlansInner.fromJson(Map<String, dynamic> json) => _$SubscriptionConfigResponsePlansInnerFromJson(json);

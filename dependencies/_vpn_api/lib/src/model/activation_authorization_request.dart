...
class ActivationAuthorizationRequest {
  ...
  final String requestId;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ActivationAuthorizationRequest &&
  ...
  factory ActivationAuthorizationRequest.fromJson(Map<String, dynamic> json) => _$ActivationAuthorizationRequestFromJson(json);

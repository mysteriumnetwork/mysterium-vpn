...
class ProxyConnectResponse {
  ...
  final bool? limitExceeded;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ProxyConnectResponse &&
  ...
  factory ProxyConnectResponse.fromJson(Map<String, dynamic> json) => _$ProxyConnectResponseFromJson(json);

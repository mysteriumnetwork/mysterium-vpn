...
class CreateAppleSubscriptionRequest {
  ...
  final String planId;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is CreateAppleSubscriptionRequest &&
  ...
  factory CreateAppleSubscriptionRequest.fromJson(Map<String, dynamic> json) => _$CreateAppleSubscriptionRequestFromJson(json);

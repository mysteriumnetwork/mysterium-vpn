...
class OAuth2TokenRequestOneOf1 {
  ...
  final String code;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is OAuth2TokenRequestOneOf1 &&
  ...
  factory OAuth2TokenRequestOneOf1.fromJson(Map<String, dynamic> json) => _$OAuth2TokenRequestOneOf1FromJson(json);

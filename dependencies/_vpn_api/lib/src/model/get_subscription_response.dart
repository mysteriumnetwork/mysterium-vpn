...
class GetSubscriptionResponse {
  ...
  final String? orderCouponUsed;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is GetSubscriptionResponse &&
      other.active == active &&
  ...
  factory GetSubscriptionResponse.fromJson(Map<String, dynamic> json) => _$GetSubscriptionResponseFromJson(json);

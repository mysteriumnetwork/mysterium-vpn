...
class CreateAppleSubscriptionResponse {
  ...
  final String subscriptionProductId;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is CreateAppleSubscriptionResponse &&
  ...
  factory CreateAppleSubscriptionResponse.fromJson(Map<String, dynamic> json) => _$CreateAppleSubscriptionResponseFromJson(json);

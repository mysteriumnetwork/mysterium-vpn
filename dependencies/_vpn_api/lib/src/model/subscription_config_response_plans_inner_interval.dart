...
class SubscriptionConfigResponsePlansInnerInterval {
  ...
  final num amount;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is SubscriptionConfigResponsePlansInnerInterval &&
      other.unit == unit &&
      other.amount == amount;
  ...
  factory SubscriptionConfigResponsePlansInnerInterval.fromJson(Map<String, dynamic> json) => _$SubscriptionConfigResponsePlansInnerIntervalFromJson(json);

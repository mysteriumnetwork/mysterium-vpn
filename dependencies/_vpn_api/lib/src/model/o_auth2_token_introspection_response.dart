...
class OAuth2TokenIntrospectionResponse {
  ...
  final num? exp;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is OAuth2TokenIntrospectionResponse &&
      other.active == active &&
  ...
  factory OAuth2TokenIntrospectionResponse.fromJson(Map<String, dynamic> json) => _$OAuth2TokenIntrospectionResponseFromJson(json);

...
class ProxyConnectResponseProxyConfig {
  ...
  final DateTime expiresAt;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ProxyConnectResponseProxyConfig &&
      other.host == host &&
      other.port == port &&
  ...
  factory ProxyConnectResponseProxyConfig.fromJson(Map<String, dynamic> json) => _$ProxyConnectResponseProxyConfigFromJson(json);

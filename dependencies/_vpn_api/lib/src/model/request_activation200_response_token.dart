...
class RequestActivation200ResponseToken {
  ...
  final String userId;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is RequestActivation200ResponseToken &&
  ...
  factory RequestActivation200ResponseToken.fromJson(Map<String, dynamic> json) => _$RequestActivation200ResponseTokenFromJson(json);

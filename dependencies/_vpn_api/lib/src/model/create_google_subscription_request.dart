...
class CreateGoogleSubscriptionRequest {
  ...
  final String planId;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is CreateGoogleSubscriptionRequest &&
  ...
  factory CreateGoogleSubscriptionRequest.fromJson(Map<String, dynamic> json) => _$CreateGoogleSubscriptionRequestFromJson(json);

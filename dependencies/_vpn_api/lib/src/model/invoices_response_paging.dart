...
class InvoicesResponsePaging {
  ...
  final num totalCount;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is InvoicesResponsePaging &&
      other.page == page &&
  ...
  factory InvoicesResponsePaging.fromJson(Map<String, dynamic> json) => _$InvoicesResponsePagingFromJson(json);

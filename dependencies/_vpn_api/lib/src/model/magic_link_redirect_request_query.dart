...
class MagicLinkRedirectRequestQuery {
  ...
  final String? continueTo;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is MagicLinkRedirectRequestQuery &&
      other.code == code &&
  ...
  factory MagicLinkRedirectRequestQuery.fromJson(Map<String, dynamic> json) => _$MagicLinkRedirectRequestQueryFromJson(json);

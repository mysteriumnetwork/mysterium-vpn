...
class CheckAuth401Response {
  ...
  final CheckAuth401ResponseError error;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is CheckAuth401Response &&
      other.status == status &&
      other.path == path &&
      other.error == error;
  ...
  factory CheckAuth401Response.fromJson(Map<String, dynamic> json) => _$CheckAuth401ResponseFromJson(json);

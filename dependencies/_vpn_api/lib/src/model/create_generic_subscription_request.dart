...
class CreateGenericSubscriptionRequest {
  ...
  final bool? embedded;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is CreateGenericSubscriptionRequest &&
  ...
  factory CreateGenericSubscriptionRequest.fromJson(Map<String, dynamic> json) => _$CreateGenericSubscriptionRequestFromJson(json);

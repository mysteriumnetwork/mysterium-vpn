...
ThemeData themeData(Palette palette) => ThemeData(
  ...
  tabBarTheme: TabBarThemeData(indicatorColor: palette.secondaryColor),
  ...
  switchTheme: SwitchThemeData(
    thumbColor: WidgetStateProperty.all(Palette.veryLightBlue),
  ...
  inputDecorationTheme: InputDecorationTheme(
    ...
    errorBorder: OutlineInputBorder(
      borderSide: const BorderSide(color: Palette.pink),
      borderRadius: BorderRadius.circular(10),
    ),
  ...
  extensions: <ThemeExtension<dynamic>>[
    _ThemeColorsX(isDarkMode: palette is DarkPalette),
    _DesignSystemThemeX(

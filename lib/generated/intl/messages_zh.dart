...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(location) =>
      "${location} 没有其他可用的 IP。请选择其他国家/地区或城市，下次即可获得不同的 IP。";

  static String m10(location) =>
      "${location} 没有其他可用的 IP。请选择其他国家/地区，下次即可获得不同的 IP。";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "onboardingStep1Desc": MessageLookupByLibrary.simpleMessage(
      "网站、追踪器和公共 Wi-Fi 网络都能看到你的 IP 和位置。",
    ),
    ...
    "residentialCentreComparisonCardItem1":
        MessageLookupByLibrary.simpleMessage("看起来像真实用户"),
    "residentialCentreComparisonCardItem2":
        MessageLookupByLibrary.simpleMessage("更难被检测"),
    "residentialCentreComparisonCardItem3":
        MessageLookupByLibrary.simpleMessage("更少被屏蔽"),
    ...
    "setupTunnerPermissionsDialogDisclaimer":
        MessageLookupByLibrary.simpleMessage("你的匿名性是安全的。我们不会查看、收集或存储你的任何浏览活动。"),
    ...
    "tooManyConnectionsBannerCTADisconnect":
        MessageLookupByLibrary.simpleMessage("断开连接"),
    "tooManyConnectionsBannerCTAReconnect":
        MessageLookupByLibrary.simpleMessage("重新连接"),

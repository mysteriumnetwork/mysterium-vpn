...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(date) => "可用至 ${date}";

  static String m1(store) => "你已通过 ${store} 付费订阅。请在 ${store} 中管理。";

  static String m2(amount, period) => "${amount} /${period}";

  static String m3(amount, period) => "${amount}/月 — 按${period}计费";

  static String m4(location) => "连接到 ${location}";

  static String m5(couponCode) => "${couponCode} 已复制到剪贴板！";

  static String m6(email) => "我们已向 ${email} 发送了一封电子邮件";

  static String m7(email) => "你可能已使用“${email}”购买了付费订阅";

  static String m8(errorCode) => "连接失败。请重试 [错误：${errorCode}]";
  ...
  static String m23(location) => "刷新 ${location}";

  static String m24(date) => "${date} 续订";

  static String m25(count) => "${Intl.plural(count, zero: '重新发送', other: '重新发送 (${count})')}";

  static String m26(percent) => "节省 ${percent}%";

  static String m27(percent, planId) => "选择 ${planId} 套餐可节省 ${percent}%";

  static String m28(plan) => "升级到 ${plan}";

  static String m29(plan) => "升级到 ${plan} 套餐";

  static String m30(location) => "切换到 ${location}";

  static String m31(word) => "输入 ${word}";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "LoggingYouIn": MessageLookupByLibrary.simpleMessage("正在为你登录…"),
    "acceptOfferBtn": MessageLookupByLibrary.simpleMessage("接受优惠"),
    "accessAvailableUntilLbl": MessageLookupByLibrary.simpleMessage("可用至："),
    ...
    "cancelDisconnects": MessageLookupByLibrary.simpleMessage("断开连接"),
    "cancelDowntimes": MessageLookupByLibrary.simpleMessage("停机时间"),
    "cancelError7040": MessageLookupByLibrary.simpleMessage("错误 7040"),
    "cancelLatency": MessageLookupByLibrary.simpleMessage("延迟"),
    "cancelMissingFeatures": MessageLookupByLibrary.simpleMessage("缺失功能"),
    ...
    "connectedSince": MessageLookupByLibrary.simpleMessage("已连接时长"),
    ...
    "highSpeed": MessageLookupByLibrary.simpleMessage("数据中心"),
    ...
    "ipDetails": MessageLookupByLibrary.simpleMessage("IP 详情"),
    "ipPool": MessageLookupByLibrary.simpleMessage("IP 池"),
    "ipPoolLabel": m11,
    ...
    "keepSubscriptionBtn": MessageLookupByLibrary.simpleMessage("保留订阅"),
    ...
    "myIp": MessageLookupByLibrary.simpleMessage("我的 IP"),
    ...
    "notReadyToCancelTitle": MessageLookupByLibrary.simpleMessage("还没准备好取消？"),
    ...
    "onboardingStep3Desc": MessageLookupByLibrary.simpleMessage("使用住宅 IP，你的连接看起来自然——不像典型的 VPN 流量。"),
    ...
    "residentialCentreComparisonCardLbl": MessageLookupByLibrary.simpleMessage("住宅 IP"),
    "residentialEducationBlock1Body": MessageLookupByLibrary.simpleMessage(
      "住宅 IP 来自真实家用设备，使你的流量看起来像普通的互联网使用。",
    ),
    ...
    "residentialEducationBlock3Body": MessageLookupByLibrary.simpleMessage(
      "若你当前的 IP 不可用，应用会将你重新连接到最近的可用住宅 IP。",
    ),
    ...
    "subscriptionPlanPF4Plus": MessageLookupByLibrary.simpleMessage("7,500+ 个住宅 IP"),
    ...
    "subscriptionPlanResidentialIPs": MessageLookupByLibrary.simpleMessage("住宅 IP"),
    ...
    "vpnDetails": MessageLookupByLibrary.simpleMessage("VPN 详情"),

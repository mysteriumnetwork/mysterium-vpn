...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(date) => "Accès disponible jusqu’au ${date}";
  ...
  static String m3(amount, period) => "${amount}/mois — Facturé ${period}";

  static String m4(location) => "Se connecter à ${location}";

  static String m5(couponCode) => "${couponCode} copié dans le presse-papiers !";

  static String m6(email) => "Nous avons envoyé un e-mail à ${email}";

  static String m7(email) => "Tu as peut-être déjà un abonnement payant avec « ${email} »";

  static String m8(errorCode) => "Échec de la connexion. Réessaie [erreur : ${errorCode}]";
  ...
  static String m14(count) =>
      "${Intl.plural(count, zero: '${count} villes', one: '${count} ville', other: '${count} villes')}";

  static String m15(count) =>
      "${Intl.plural(count, zero: '${count} IP', one: '${count} IP', other: '${count} IP')}";

  static String m16(count) =>
      "${Intl.plural(count, zero: '${count} États', one: '${count} État', other: '${count} États')}";
  ...
  static String m21(count) =>
      "${Intl.plural(count, zero: 'Pause de ${count} mois', one: 'Pause de ${count} mois', other: 'Pause de ${count} mois')}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "connectedSince": MessageLookupByLibrary.simpleMessage("Connecté depuis"),
    ...
    "connectionDetails": MessageLookupByLibrary.simpleMessage("Détails de connexion"),
    ...
    "continueCancellationOnWebDesc": MessageLookupByLibrary.simpleMessage(
      "Tu seras redirigé vers le site Mysterium VPN pour finaliser ton annulation.",
    ),
    "continueCancellationOnWebTitle": MessageLookupByLibrary.simpleMessage(
      "Continuer l’annulation sur le web",
    ),
    "continueToCancelBtn": MessageLookupByLibrary.simpleMessage("Continuer l’annulation"),
    "continueToWebBtn": MessageLookupByLibrary.simpleMessage("Aller sur le site"),
    ...
    "datacenterIpBadge": MessageLookupByLibrary.simpleMessage("IP de centre de données"),
    ...
    "favoriteIpsEmptyBody": MessageLookupByLibrary.simpleMessage(
      "Connecte-toi et appuie sur le cœur de la carte de connexion pour enregistrer une IP et y accéder rapidement.",
    ),
    "favoriteIpsEmptyTitle": MessageLookupByLibrary.simpleMessage(
      "Aucune IP favorite pour l’instant",
    ),
    "favoriteIpsLabel": MessageLookupByLibrary.simpleMessage("IP favorites"),
    "favoriteIpsLockedBody": MessageLookupByLibrary.simpleMessage(
      "Passe à Plus ou Pro pour enregistrer les IP qui te conviennent et y accéder rapidement quand tu en as besoin.",
    ),
    "favoriteIpsLockedTitle": MessageLookupByLibrary.simpleMessage("Enregistre tes IP favorites"),
    "favoriteIpsNotAvailableOnPlan": MessageLookupByLibrary.simpleMessage(
      "Les IP enregistrées ne sont pas disponibles avec ton offre actuelle.",
    ),
    "favoriteIpsTab": MessageLookupByLibrary.simpleMessage("Favoris"),
    "favoriteIpsUnavailableHeading": MessageLookupByLibrary.simpleMessage("IP indisponibles"),
    "favoriteIpsUpgradePlan": MessageLookupByLibrary.simpleMessage("Améliorer l’offre"),
    ...
    "ipDetails": MessageLookupByLibrary.simpleMessage("Détails IP"),
    "ipPool": MessageLookupByLibrary.simpleMessage("Pool d\'IP"),
    "ipPoolLabel": m11,
    "ipRefreshExhaustedCity": m12,
    "ipRefreshExhaustedCountry": m13,
    "ipType": MessageLookupByLibrary.simpleMessage("Type d\'IP"),
    ...
    "ipTypeDataCenterTab": MessageLookupByLibrary.simpleMessage("Centre de données"),
    ...
    "ipTypeResidentialTab": MessageLookupByLibrary.simpleMessage("Résidentiel"),
    ...
    "manageFavoriteIpsBtn": MessageLookupByLibrary.simpleMessage("Gérer"),
    ...
    "myIp": MessageLookupByLibrary.simpleMessage("Mon IP"),
    ...
    "pauseSubscriptionFailed": MessageLookupByLibrary.simpleMessage(
      "Impossible de mettre ton abonnement en pause. Réessaie.",
    ),
    "pauseSubscriptionInfoDesc": MessageLookupByLibrary.simpleMessage(
      "Tu peux mettre ton plan en pause une fois par cycle de facturation.",
    ),
    "paused": MessageLookupByLibrary.simpleMessage("En pause"),
    "pausedUntil": m22,
    ...
    "plan_2_years_plus": MessageLookupByLibrary.simpleMessage("Plus 2 ans"),
    ...
    "residentialIpBadge": MessageLookupByLibrary.simpleMessage("IP résidentielle"),
    "resumeBtn": MessageLookupByLibrary.simpleMessage("Reprendre"),
    "resumeSubscriptionFailed": MessageLookupByLibrary.simpleMessage(
      "Impossible de reprendre ton abonnement. Réessaie.",
    ),
    "resumeSubscriptionPromptDesc": MessageLookupByLibrary.simpleMessage(
      "Ton abonnement reprendra immédiatement.",
    ),
    "resumeSubscriptionTitle": MessageLookupByLibrary.simpleMessage("Reprendre l’abonnement ?"),
    ...
    "stayOnAppBtn": MessageLookupByLibrary.simpleMessage("Rester dans l’app"),
    ...
    "vpnDetails": MessageLookupByLibrary.simpleMessage("Détails VPN"),
    "vpnIp": MessageLookupByLibrary.simpleMessage("IP du VPN"),

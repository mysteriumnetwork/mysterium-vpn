...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(store) =>
      "لديك بالفعل اشتراك نشط مدفوع عبر ${store}. يمكنك إدارته من ${store}.";

  static String m1(amount, period) => "${amount} /${period}";

  static String m2(amount, period) => "${amount}/شهر — يُحصَّل ${period}";

  static String m3(couponCode) => "تم نسخ ${couponCode} إلى الحافظة!";

  static String m4(email) => "أرسلنا بريدًا إلكترونيًا إلى ${email}";

  static String m5(email) =>
      "قد يكون لديك بالفعل اشتراك مدفوع باستخدام “${email}”";

  static String m6(errorCode) =>
      "فشل الاتصال. يُرجى المحاولة مرة أخرى [الخطأ: ${errorCode}]";
  ...
  static String m14(location) => "${location} غير متاح";

  static String m15(location) => "تعذّر تحديث ${location}";

  static String m16(location) => "تم تحديث ${location}";

  static String m17(date) => "الفوترة التالية: ${date}";

  static String m18(protocol, label) => "${protocol} (${label})";

  static String m19(location) => "تحديث ${location}";
  ...
  static String m21(percent) => "وفّر ${percent}%";

  static String m22(percent, planId) => "وفّر ${percent}% مع خطة ${planId}";

  static String m23(plan) => "الترقية إلى ${plan}";

  static String m24(plan) => "الترقية إلى خطة ${plan}";

  static String m25(location) => "التبديل إلى ${location}";

  static String m26(word) => "اكتب ${word}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "getNewIPAddress": MessageLookupByLibrary.simpleMessage(
      "احصل على عنوان IP جديد عند التحديث",
    ),
    ...
    "noEmailApp": MessageLookupByLibrary.simpleMessage(
      "لا توجد تطبيقات بريد إلكتروني على جهازك.",
    ),
    ...
    "onboardingStep2Title": MessageLookupByLibrary.simpleMessage(
      "أخفِ هويتك الحقيقية بنقرة واحدة",
    ),
    ...
    "resetAppDesc": MessageLookupByLibrary.simpleMessage(
      "أعد الضبط عندما لا يعمل شيء ما",
    ),
    ...
    "residentialCentreComparisonCardItem1":
        MessageLookupByLibrary.simpleMessage("تبدو كمستخدم حقيقي"),
    "residentialCentreComparisonCardItem2":
        MessageLookupByLibrary.simpleMessage("أصعب في الاكتشاف"),
    "residentialCentreComparisonCardItem3":
        MessageLookupByLibrary.simpleMessage("حجب أقل"),
    ...
    "reviewPositiveTitle": MessageLookupByLibrary.simpleMessage(
      "رائع! هل تمانع في ترك تقييم لنا؟",
    ),
    ...
    "selectEmailApp": MessageLookupByLibrary.simpleMessage(
      "اختر تطبيق البريد الإلكتروني للمتابعة",
    ),
    ...
    "subscriptionOnboardingBoostProtectionTitle":
        MessageLookupByLibrary.simpleMessage("عزّز حمايتك"),
    "subscriptionOnboardingCancelTourLabel":
        MessageLookupByLibrary.simpleMessage("تخطٍّ الآن"),
    "subscriptionOnboardingConnectDescription":
        MessageLookupByLibrary.simpleMessage("سنوصلك بأفضل خادم."),
    ...
    "subscriptionOnboardingManagePlanTitle":
        MessageLookupByLibrary.simpleMessage("إدارة خطتك"),
    ...
    "subscriptionOnboardingSetupCompleteTitle":
        MessageLookupByLibrary.simpleMessage("اكتمل الإعداد"),
    "subscriptionOnboardingStartTourLabel":
        MessageLookupByLibrary.simpleMessage("بدء الجولة"),
    ...
    "subscriptionOnboardingVPNLocationsTitle":
        MessageLookupByLibrary.simpleMessage("تصفّح مواقع VPN"),
    ...
    "tooManyConnectionsBannerCTADisconnect":
        MessageLookupByLibrary.simpleMessage("قطع الاتصال"),

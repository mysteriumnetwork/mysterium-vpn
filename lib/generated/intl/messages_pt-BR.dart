...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m11(count) => "Pool de IP: ${count}";
  ...
  static String m22(date) => "Pausado até ${date}";

  static String m23(protocol, label) => "${protocol} (${label})";

  static String m24(location) => "Atualizar ${location}";

  static String m25(date) => "Renova em ${date}";

  static String m26(count) =>
      "${Intl.plural(count, zero: 'Enviar novamente', one: 'Enviar novamente', other: 'Enviar novamente (${count})')}";

  static String m27(percent) => "Economize ${percent}%";

  static String m28(percent, planId) => "Economize ${percent}% com um plano ${planId}";

  static String m29(plan) => "Faça upgrade para ${plan}";

  static String m30(plan) => "Faça upgrade para o plano ${plan}";

  static String m31(location) => "Mudar para ${location}";

  static String m32(word) => "Digite ${word}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "cancelSubscriptionTitle": MessageLookupByLibrary.simpleMessage("Cancelar assinatura"),
    "cancelSubscriptionWarningDesc": MessageLookupByLibrary.simpleMessage(
      "Sua assinatura será cancelada. Você pode continuar usando o Mysterium VPN até o fim do seu acesso.",
    ),
    "cancelSurveyFeedbackHint": MessageLookupByLibrary.simpleMessage("Informe mais detalhes..."),
    "cancelSurveyTellUsMoreHint": MessageLookupByLibrary.simpleMessage("Conte mais (opcional)"),
    ...
    "continueCancellationOnWebDesc": MessageLookupByLibrary.simpleMessage(
      "Você será redirecionado para o site da Mysterium VPN para concluir o cancelamento.",
    ),
    "continueCancellationOnWebTitle": MessageLookupByLibrary.simpleMessage(
      "Continuar o cancelamento na web",
    ),
    "continueToCancelBtn": MessageLookupByLibrary.simpleMessage("Continuar cancelamento"),
    ...
    "keepSubscriptionBtn": MessageLookupByLibrary.simpleMessage("Manter assinatura"),
    ...
    "nextBilling": m20,
    "nextBillingDateLbl": MessageLookupByLibrary.simpleMessage("Próxima data de cobrança:"),
    ...
    "notReadyToCancelTitle": MessageLookupByLibrary.simpleMessage("Ainda não quer cancelar?"),
    ...
    "pauseDurationRequiredError": MessageLookupByLibrary.simpleMessage(
      "Selecione uma duração da pausa.",
    ),
    "pauseForMonths": m21,
    "pauseSubscriptionBtn": MessageLookupByLibrary.simpleMessage("Pausar assinatura"),
    "pauseSubscriptionFailed": MessageLookupByLibrary.simpleMessage(
      "Não foi possível pausar sua assinatura. Tente novamente.",
    ),
    "pauseSubscriptionInfoDesc": MessageLookupByLibrary.simpleMessage(
      "Você pode pausar seu plano uma vez por ciclo de cobrança.",
    ),
    ...
    "reactivateSubscriptionAnytimeDesc": MessageLookupByLibrary.simpleMessage(
      "Você pode reativar sua assinatura a qualquer momento antes do fim do seu acesso.",
    ),
    ...
    "residentialEducationBlock1Body": MessageLookupByLibrary.simpleMessage(
      "IPs residenciais vêm de dispositivos domésticos reais, fazendo seu tráfego parecer uso normal da internet.",
    ),
    ...
    "residentialEducationBlock3Body": MessageLookupByLibrary.simpleMessage(
      "Se seu IP atual ficar indisponível, o app reconecta você ao IP residencial disponível mais próximo.",
    ),
    ...
    "resumeSubscriptionFailed": MessageLookupByLibrary.simpleMessage(
      "Não foi possível retomar sua assinatura. Tente novamente.",
    ),
    "resumeSubscriptionPromptDesc": MessageLookupByLibrary.simpleMessage(
      "Sua assinatura será retomada imediatamente.",
    ),
    "resumeSubscriptionTitle": MessageLookupByLibrary.simpleMessage("Retomar assinatura?"),
    ...
    "stayOnAppBtn": MessageLookupByLibrary.simpleMessage("Ficar no app"),
    ...
    "subscriptionCancelledTitle": MessageLookupByLibrary.simpleMessage("Assinatura cancelada"),

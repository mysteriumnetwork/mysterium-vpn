...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(date) => "Dostęp ważny do ${date}";
  ...
  static String m3(amount, period) => "${amount}/miesiąc — rozliczane ${period}";

  static String m4(location) => "Połącz z ${location}";

  static String m5(couponCode) => "Skopiowano ${couponCode} do schowka!";

  static String m6(email) => "Wysłaliśmy e-mail na adres ${email}";

  static String m7(email) => "Możesz już mieć płatną subskrypcję na koncie „${email}”";

  static String m8(errorCode) => "Nie udało się połączyć. Spróbuj ponownie [błąd: ${errorCode}]";

  static String m9(plan) => "Wybierz ${plan}";

  static String m10(plan) => "Wybierz plan ${plan}";

  static String m11(count) => "Pula IP: ${count}";
  ...
  static String m14(count) =>
      "${Intl.plural(count, zero: '${count} miasta', one: '${count} miasto', few: '${count} miasta', many: '${count} miast', other: '${count} miasta')}";

  static String m15(count) =>
      "${Intl.plural(count, zero: '${count} IP', one: '${count} IP', few: '${count} IP', many: '${count} IP', other: '${count} IP')}";

  static String m16(count) =>
      "${Intl.plural(count, zero: '${count} regionu', one: '${count} region', few: '${count} regiony', many: '${count} regionów', other: '${count} regionu')}";

  static String m17(location) => "${location} jest niedostępna";

  static String m18(location) => "Nie udało się zaktualizować ${location}";

  static String m19(location) => "Zaktualizowano ${location}";
  ...
  static String m23(location) => "Odśwież ${location}";

  static String m24(date) => "Odnawia się ${date}";
  ...
  static String m26(percent) => "Zaoszczędź ${percent}%";

  static String m27(percent, planId) => "Zaoszczędź ${percent}% z planem ${planId}";

  static String m28(plan) => "Przejdź na ${plan}";

  static String m29(plan) => "Przejdź na plan ${plan}";

  static String m30(location) => "Przełącz na ${location}";

  static String m31(word) => "Wpisz ${word}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "cancelled": MessageLookupByLibrary.simpleMessage("Anulowana"),
    "changeIpOnReconnect": MessageLookupByLibrary.simpleMessage(
      "Zmieniaj IP przy ponownym łączeniu",
    ),
    "changeIpOnReconnectDesc": MessageLookupByLibrary.simpleMessage(
      "Używaj innego IP przy każdym połączeniu",
    ),
    ...
    "connectedSince": MessageLookupByLibrary.simpleMessage("Czas połączenia"),
    ...
    "connectionDetails": MessageLookupByLibrary.simpleMessage("Szczegóły połączenia"),
    ...
    "datacenterIpBadge": MessageLookupByLibrary.simpleMessage("IP z centrum danych"),
    ...
    "favoriteIpsEmptyBody": MessageLookupByLibrary.simpleMessage(
      "Połącz się i dotknij serca na karcie połączenia, aby zapisać IP i mieć do niego szybki dostęp.",
    ),
    "favoriteIpsEmptyTitle": MessageLookupByLibrary.simpleMessage("Brak ulubionych IP"),
    "favoriteIpsLabel": MessageLookupByLibrary.simpleMessage("Ulubione IP"),
    "favoriteIpsLockedBody": MessageLookupByLibrary.simpleMessage(
      "Przejdź na Plus lub Pro, aby zapisywać IP, które działają najlepiej, i szybko z nich korzystać.",
    ),
    "favoriteIpsLockedTitle": MessageLookupByLibrary.simpleMessage("Zapisuj ulubione IP"),
    "favoriteIpsNotAvailableOnPlan": MessageLookupByLibrary.simpleMessage(
      "Zapisane IP nie są dostępne w Twoim obecnym planie.",
    ),
    "favoriteIpsTab": MessageLookupByLibrary.simpleMessage("Ulubione"),
    "favoriteIpsUnavailableHeading": MessageLookupByLibrary.simpleMessage("Niedostępne IP"),
    "favoriteIpsUpgradePlan": MessageLookupByLibrary.simpleMessage("Ulepsz plan"),
    ...
    "getAPlanBtn": MessageLookupByLibrary.simpleMessage("Wybierz plan"),
    ...
    "ipDetails": MessageLookupByLibrary.simpleMessage("Szczegóły IP"),
    "ipPool": MessageLookupByLibrary.simpleMessage("Pula IP"),
    "ipPoolLabel": m11,
    "ipRefreshExhaustedCity": m12,
    "ipRefreshExhaustedCountry": m13,
    "ipType": MessageLookupByLibrary.simpleMessage("Typ IP"),
    ...
    "ipTypeDataCenterTab": MessageLookupByLibrary.simpleMessage("Centrum danych"),
    ...
    "ipTypeResidentialTab": MessageLookupByLibrary.simpleMessage("Mieszkaniowe"),
    ...
    "manageFavoriteIpsBtn": MessageLookupByLibrary.simpleMessage("Zarządzaj"),
    ...
    "myIp": MessageLookupByLibrary.simpleMessage("Moje IP"),
    ...
    "paused": MessageLookupByLibrary.simpleMessage("Wstrzymana"),
    "pausedUntil": m22,
    ...
    "resumeSubscriptionTitle": MessageLookupByLibrary.simpleMessage("Wznowić subskrypcję?"),
    ...
    "subscriptionResumed": MessageLookupByLibrary.simpleMessage(
      "Twoja subskrypcja jest znowu aktywna.",
    ),
    ...
    "udpBlockedConfirm": MessageLookupByLibrary.simpleMessage("Przełącz na OpenVPN"),
    "udpBlockedDesc": MessageLookupByLibrary.simpleMessage(
      "Wygląda na to, że WireGuard jest zablokowany w tej sieci. OpenVPN łączy się inaczej i zwykle tu działa. Przełączyć teraz?",
    ),
    "udpBlockedSwitched": MessageLookupByLibrary.simpleMessage(
      "Przełączono na OpenVPN. Możesz to zmienić w każdej chwili w Ustawieniach.",
    ),
    "udpBlockedTitle": MessageLookupByLibrary.simpleMessage("Połączenie WireGuard zablokowane"),
    ...
    "vpnDetails": MessageLookupByLibrary.simpleMessage("Szczegóły VPN"),

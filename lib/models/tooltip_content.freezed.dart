...
/// @nodoc
mixin _$TooltipContent {

 String get title; String get description; IconData? get icon; String get actionLabel;
...
@override
int get hashCode => Object.hash(runtimeType,title,description,icon,actionLabel);

@override
String toString() {
  return 'TooltipContent(title: $title, description: $description, icon: $icon, actionLabel: $actionLabel)';
}
...
@useResult
$Res call({
 String title, String description, IconData? icon, String actionLabel
});
...
/// Create a copy of TooltipContent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = null,Object? description = null,Object? icon = freezed,Object? actionLabel = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  String description,  IconData? icon,  String actionLabel)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TooltipContent() when $default != null:
return $default(_that.title,_that.description,_that.icon,_that.actionLabel);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  String description,  IconData? icon,  String actionLabel)  $default,) {final _that = this;
switch (_that) {
case _TooltipContent():
return $default(_that.title,_that.description,_that.icon,_that.actionLabel);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  String description,  IconData? icon,  String actionLabel)?  $default,) {final _that = this;
switch (_that) {
case _TooltipContent() when $default != null:
return $default(_that.title,_that.description,_that.icon,_that.actionLabel);case _:
  return null;
...
class _TooltipContent implements TooltipContent {
   _TooltipContent({required this.title, required this.description, required this.icon, this.actionLabel = LocaleKeys.continueBtn});
...
/// Create a copy of TooltipContent
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? description = null,Object? icon = freezed,Object? actionLabel = null,}) {

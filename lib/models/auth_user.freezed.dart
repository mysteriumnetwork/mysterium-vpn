...
AuthUser _$AuthUserFromJson(
  Map<String, dynamic> json
) {
    return _AuthData.fromJson(
      json
    );
}
...
@JsonKey(name: 'sub') String get userId;@JsonKey(name: 'username') String get username;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthUser&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.username, username) || other.username == username));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'sub')  String userId, @JsonKey(name: 'username')  String username)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthData() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'sub')  String userId, @JsonKey(name: 'username')  String username)  $default,) {final _that = this;
switch (_that) {
case _AuthData():
return $default(_that.userId,_that.username);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'sub')  String userId, @JsonKey(name: 'username')  String username)?  $default,) {final _that = this;
switch (_that) {
case _AuthData() when $default != null:
return $default(_that.userId,_that.username);case _:
  return null;
...
class _AuthData implements AuthUser {
   _AuthData({@JsonKey(name: 'sub') required this.userId, @JsonKey(name: 'username') required this.username});
  factory _AuthData.fromJson(Map<String, dynamic> json) => _$AuthDataFromJson(json);

@override@JsonKey(name: 'sub') final  String userId;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthData&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.username, username) || other.username == username));
}

...
mixin _$IPInfo {
 ...
 String get ip; String get country; String get city;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is IPInfo&&(identical(other.ip, ip) || other.ip == ip)&&(identical(other.country, country) || other.country == country)&&(identical(other.city, city) || other.city == city));
}
...
@useResult
$Res call({
 String ip, String country, String city
});
...
/// Create a copy of IPInfo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? ip = null,Object? country = null,Object? city = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String ip,  String country,  String city)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _IPInfo() when $default != null:
return $default(_that.ip,_that.country,_that.city);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String ip,  String country,  String city)  $default,) {final _that = this;
switch (_that) {
case _IPInfo():
return $default(_that.ip,_that.country,_that.city);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String ip,  String country,  String city)?  $default,) {final _that = this;
switch (_that) {
case _IPInfo() when $default != null:
return $default(_that.ip,_that.country,_that.city);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _IPInfo&&(identical(other.ip, ip) || other.ip == ip)&&(identical(other.country, country) || other.country == country)&&(identical(other.city, city) || other.city == city));
}
...
/// Create a copy of IPInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? ip = null,Object? country = null,Object? city = null,}) {

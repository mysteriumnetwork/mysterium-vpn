...
@JsonKey(name: 'name') String get name;@JsonKey(name: 'enabled') bool get enabled;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Gateway&&(identical(other.name, name) || other.name == name)&&(identical(other.enabled, enabled) || other.enabled == enabled));
}
...
@useResult
$Res call({
@JsonKey(name: 'name') String name,@JsonKey(name: 'enabled') bool enabled
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'name')  String name, @JsonKey(name: 'enabled')  bool enabled)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Gateway() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'name')  String name, @JsonKey(name: 'enabled')  bool enabled)  $default,) {final _that = this;
switch (_that) {
case _Gateway():
return $default(_that.name,_that.enabled);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'name')  String name, @JsonKey(name: 'enabled')  bool enabled)?  $default,) {final _that = this;
switch (_that) {
case _Gateway() when $default != null:
return $default(_that.name,_that.enabled);case _:
  return null;
...
class _Gateway implements Gateway {
   _Gateway({@JsonKey(name: 'name') required this.name, @JsonKey(name: 'enabled') required this.enabled});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Gateway&&(identical(other.name, name) || other.name == name)&&(identical(other.enabled, enabled) || other.enabled == enabled));
}

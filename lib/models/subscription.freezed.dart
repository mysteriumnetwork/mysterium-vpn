...
mixin _$Subscription {
 ...
 bool get active; String? get planId; String? get gateway; DateTime? get activeUntil; bool? get expired; bool? get recurring; String? get storePlanId; DateTime? get periodStart;
...
@override
int get hashCode => Object.hash(runtimeType,active,planId,gateway,activeUntil,expired,recurring,storePlanId,periodStart);
...
@useResult
$Res call({
 bool active, String? planId, String? gateway, DateTime? activeUntil, bool? expired, bool? recurring, String? storePlanId, DateTime? periodStart
});
...
/// Create a copy of Subscription
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? active = null,Object? planId = freezed,Object? gateway = freezed,Object? activeUntil = freezed,Object? expired = freezed,Object? recurring = freezed,Object? storePlanId = freezed,Object? periodStart = freezed,}) {
  return _then(_self.copyWith(
active: null == active ? _self.active : active // ignore: cast_nullable_to_non_nullable
as bool,planId: freezed == planId ? _self.planId : planId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool active,  String? planId,  String? gateway,  DateTime? activeUntil,  bool? expired,  bool? recurring,  String? storePlanId,  DateTime? periodStart)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Subscription() when $default != null:
return $default(_that.active,_that.planId,_that.gateway,_that.activeUntil,_that.expired,_that.recurring,_that.storePlanId,_that.periodStart);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool active,  String? planId,  String? gateway,  DateTime? activeUntil,  bool? expired,  bool? recurring,  String? storePlanId,  DateTime? periodStart)  $default,) {final _that = this;
switch (_that) {
case _Subscription():
return $default(_that.active,_that.planId,_that.gateway,_that.activeUntil,_that.expired,_that.recurring,_that.storePlanId,_that.periodStart);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool active,  String? planId,  String? gateway,  DateTime? activeUntil,  bool? expired,  bool? recurring,  String? storePlanId,  DateTime? periodStart)?  $default,) {final _that = this;
switch (_that) {
case _Subscription() when $default != null:
return $default(_that.active,_that.planId,_that.gateway,_that.activeUntil,_that.expired,_that.recurring,_that.storePlanId,_that.periodStart);case _:
  return null;
...
class _Subscription extends Subscription {
   _Subscription({required this.active, this.planId, this.gateway, this.activeUntil, this.expired, this.recurring, this.storePlanId, this.periodStart}): super._();
...
/// Create a copy of Subscription
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? active = null,Object? planId = freezed,Object? gateway = freezed,Object? activeUntil = freezed,Object? expired = freezed,Object? recurring = freezed,Object? storePlanId = freezed,Object? periodStart = freezed,}) {

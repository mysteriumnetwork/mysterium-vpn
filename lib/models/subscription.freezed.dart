...
mixin _$Subscription {
 ...
 bool get active; String? get id; String? get planId; String? get gateway; DateTime? get activeUntil; bool? get expired; bool? get recurring; bool? get paused; DateTime? get pausedUntil; String? get storePlanId; DateTime? get periodStart;
...
@override
int get hashCode => Object.hash(runtimeType,active,id,planId,gateway,activeUntil,expired,recurring,paused,pausedUntil,storePlanId,periodStart);

@override
String toString() {
  return 'Subscription(active: $active, id: $id, planId: $planId, gateway: $gateway, activeUntil: $activeUntil, expired: $expired, recurring: $recurring, paused: $paused, pausedUntil: $pausedUntil, storePlanId: $storePlanId, periodStart: $periodStart)';
}
...
@useResult
$Res call({
 bool active, String? id, String? planId, String? gateway, DateTime? activeUntil, bool? expired, bool? recurring, bool? paused, DateTime? pausedUntil, String? storePlanId, DateTime? periodStart
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool active,  String? id,  String? planId,  String? gateway,  DateTime? activeUntil,  bool? expired,  bool? recurring,  bool? paused,  DateTime? pausedUntil,  String? storePlanId,  DateTime? periodStart)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Subscription() when $default != null:
return $default(_that.active,_that.id,_that.planId,_that.gateway,_that.activeUntil,_that.expired,_that.recurring,_that.paused,_that.pausedUntil,_that.storePlanId,_that.periodStart);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool active,  String? id,  String? planId,  String? gateway,  DateTime? activeUntil,  bool? expired,  bool? recurring,  bool? paused,  DateTime? pausedUntil,  String? storePlanId,  DateTime? periodStart)  $default,) {final _that = this;
switch (_that) {
case _Subscription():
return $default(_that.active,_that.id,_that.planId,_that.gateway,_that.activeUntil,_that.expired,_that.recurring,_that.paused,_that.pausedUntil,_that.storePlanId,_that.periodStart);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool active,  String? id,  String? planId,  String? gateway,  DateTime? activeUntil,  bool? expired,  bool? recurring,  bool? paused,  DateTime? pausedUntil,  String? storePlanId,  DateTime? periodStart)?  $default,) {final _that = this;
switch (_that) {
case _Subscription() when $default != null:
return $default(_that.active,_that.id,_that.planId,_that.gateway,_that.activeUntil,_that.expired,_that.recurring,_that.paused,_that.pausedUntil,_that.storePlanId,_that.periodStart);case _:
  return null;
...
class _Subscription extends Subscription {
   _Subscription({required this.active, this.id, this.planId, this.gateway, this.activeUntil, this.expired, this.recurring, this.paused, this.pausedUntil, this.storePlanId, this.periodStart}): super._();

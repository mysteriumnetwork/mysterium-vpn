...
mixin _$ProductOffer {
 ...
 String get id; double get price; double get fullPrice; OfferDuration get durationUnit; int get durationValue;
...
/// Create a copy of ProductOffer
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? price = null,Object? fullPrice = null,Object? durationUnit = null,Object? durationValue = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,price: null == price ? _self.price : price // ignore: cast_nullable_to_non_nullable
as double,fullPrice: null == fullPrice ? _self.fullPrice : fullPrice // ignore: cast_nullable_to_non_nullable
as double,durationUnit: null == durationUnit ? _self.durationUnit : durationUnit // ignore: cast_nullable_to_non_nullable
as OfferDuration,durationValue: null == durationValue ? _self.durationValue : durationValue // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  double price,  double fullPrice,  OfferDuration durationUnit,  int durationValue)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProductOffer() when $default != null:
return $default(_that.id,_that.price,_that.fullPrice,_that.durationUnit,_that.durationValue);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  double price,  double fullPrice,  OfferDuration durationUnit,  int durationValue)  $default,) {final _that = this;
switch (_that) {
case _ProductOffer():
return $default(_that.id,_that.price,_that.fullPrice,_that.durationUnit,_that.durationValue);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  double price,  double fullPrice,  OfferDuration durationUnit,  int durationValue)?  $default,) {final _that = this;
switch (_that) {
case _ProductOffer() when $default != null:
return $default(_that.id,_that.price,_that.fullPrice,_that.durationUnit,_that.durationValue);case _:
  return null;
...
class _ProductOffer extends ProductOffer {
   _ProductOffer({required this.id, required this.price, required this.fullPrice, required this.durationUnit, required this.durationValue}): super._();
  factory _ProductOffer.fromJson(Map<String, dynamic> json) => _$ProductOfferFromJson(json);

@override final  String id;
@override final  double price;
@override final  double fullPrice;
@override final  OfferDuration durationUnit;
...
/// Create a copy of ProductOffer
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? price = null,Object? fullPrice = null,Object? durationUnit = null,Object? durationValue = null,}) {

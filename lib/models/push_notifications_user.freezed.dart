...
mixin _$PushNotificationsUser {
  ...
  $PushNotificationsUserCopyWith<PushNotificationsUser> get copyWith =>
      _$PushNotificationsUserCopyWithImpl<PushNotificationsUser>(
          this as PushNotificationsUser, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PushNotificationsUser &&
...
abstract mixin class $PushNotificationsUserCopyWith<$Res> {
  factory $PushNotificationsUserCopyWith(
...
/// @nodoc
class _$PushNotificationsUserCopyWithImpl<$Res> implements $PushNotificationsUserCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_self.copyWith(
      pushNotificationsId: freezed == pushNotificationsId
          ? _self.pushNotificationsId
          : pushNotificationsId // ignore: cast_nullable_to_non_nullable
              as String?,
...
extension PushNotificationsUserPatterns on PushNotificationsUser {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PushNotificationsUser value)? $default, {
...
class _PushNotificationsUser implements PushNotificationsUser {
  ...
  @override
  final String? pushNotificationsId;
  @override
  final String? userId;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PushNotificationsUserCopyWith<_PushNotificationsUser> get copyWith =>
      __$PushNotificationsUserCopyWithImpl<_PushNotificationsUser>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$PushNotificationsUserToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _PushNotificationsUser &&
            (identical(other.pushNotificationsId, pushNotificationsId) ||
                other.pushNotificationsId == pushNotificationsId) &&
            (identical(other.userId, userId) || other.userId == userId) &&
...
/// @nodoc
abstract mixin class _$PushNotificationsUserCopyWith<$Res>
    implements $PushNotificationsUserCopyWith<$Res> {
  factory _$PushNotificationsUserCopyWith(
          _PushNotificationsUser value, $Res Function(_PushNotificationsUser) _then) =
...
/// @nodoc
class __$PushNotificationsUserCopyWithImpl<$Res> implements _$PushNotificationsUserCopyWith<$Res> {

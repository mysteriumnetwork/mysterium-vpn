...
enum AnalyticsEvent {
  ...
  // Notifier push lifecycle. Names map 1:1 onto the events in the spec via
  // `formattedName` (snake_case).
  pushPermissionRequested,
  pushPermissionGranted,
  pushPermissionDenied,
  pushDeviceRegistrationStarted,
  pushDeviceRegistrationSucceeded,
  pushDeviceRegistrationFailed,
  pushTokenRefreshed,

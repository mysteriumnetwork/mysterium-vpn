...
_OrderSummaryRequestData _$OrderSummaryRequestDataFromJson(
...
Map<String, dynamic> _$OrderSummaryRequestDataToJson(
  _OrderSummaryRequestData instance,
) => <String, dynamic>{
...
_OrderSummaryResponseData _$OrderSummaryResponseDataFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$OrderSummaryResponseDataToJson(
  _OrderSummaryResponseData instance,
) => <String, dynamic>{
  'orderTotal': instance.orderTotal,
  'couponError': instance.couponError,
};

_SubscribePayloadData _$SubscribePayloadDataFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$SubscribePayloadDataToJson(
  _SubscribePayloadData instance,
) => <String, dynamic>{
  'planId': instance.planId,
  'couponCode': instance.couponCode,
};

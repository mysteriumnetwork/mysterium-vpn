      ...
      child: ListView.separated(
        ...
        itemBuilder: (_, index) {
          ...
          return _Item(
            ...
            onToggleFavouritePressed:
                onToggleFavouritePressed == null ? null : () => onToggleFavouritePressed!(item),
          );
        },
      ),
    );
    ...
    return RawMaterialButton(
      ...
      child: Row(
        ...
        children: [
          ...
          if (onToggleFavouritePressed != null)
            SvgIconButton(
              asset: Asset.icons.heartFilled,
              color: theme.palette.subtitleColor,

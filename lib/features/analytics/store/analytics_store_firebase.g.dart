...
mixin _$AnalyticsStoreFirebase on _AnalyticsStoreFirebase, Store {
  late final _$logMessageAsyncAction = AsyncAction(
    '_AnalyticsStoreFirebase.logMessage',
    context: context,
  );
  ...
  late final _$logEventAsyncAction = AsyncAction(
    '_AnalyticsStoreFirebase.logEvent',
    context: context,
  );
  ...
  late final _$setUserIdAsyncAction = AsyncAction(
    '_AnalyticsStoreFirebase.setUserId',
    context: context,
  );
  ...
  late final _$setUserPropertyAsyncAction = AsyncAction(
    '_AnalyticsStoreFirebase.setUserProperty',
    context: context,
  );
  ...
  late final _$setLoginAsyncAction = AsyncAction(
    '_AnalyticsStoreFirebase.setLogin',
    context: context,
  );
  ...
  late final _$logScreenViewedAsyncAction = AsyncAction(
    '_AnalyticsStoreFirebase.logScreenViewed',
    context: context,
  );
  ...
  late final _$setConsentsAsyncAction = AsyncAction(
    '_AnalyticsStoreFirebase.setConsents',
    context: context,
  );
  ...
  late final _$setDeviceInfoAsyncAction = AsyncAction(
    '_AnalyticsStoreFirebase.setDeviceInfo',
    context: context,
  );

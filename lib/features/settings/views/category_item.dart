  ...
  Widget build(BuildContext context) =>
      Material(
            ...
            child: InkWell(
              ...
              child: Row(
                children: [
                  _SelectionIndicator(isSelected: isSelected).paddingDirectional(end: 14),
                  EasyText(
                    title,
...
class _SelectionIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) => isSelected
      ? const CircleBox(size: 10, color: Palette.purple)
      : CircleBox(size: 4, color: Theme.of(context).tabBarTheme.indicatorColor ?? Palette.purple);
}

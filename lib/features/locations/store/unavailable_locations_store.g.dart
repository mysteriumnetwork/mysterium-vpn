...
mixin _$UnavailableLocationsStore on _UnavailableLocationsStore, Store {
  late final _$_unavailableLocationsAtom = Atom(
    name: '_UnavailableLocationsStore._unavailableLocations',
    context: context,
  );
  ...
  set _unavailableLocations(Set<VPNLocation> value) {
    _$_unavailableLocationsAtom.reportWrite(
      value,
      __unavailableLocationsIsInitialized ? super._unavailableLocations : null,
      () {
  ...
  late final _$_UnavailableLocationsStoreActionController = ActionController(
    name: '_UnavailableLocationsStore',
    context: context,
  );

  @override
  void toggleAvailability(VPNLocation location, {bool? availability}) {
    final _$actionInfo = _$_UnavailableLocationsStoreActionController
        .startAction(name: '_UnavailableLocationsStore.toggleAvailability');
    try {
  ...
  void clear() {
    final _$actionInfo = _$_UnavailableLocationsStoreActionController
        .startAction(name: '_UnavailableLocationsStore.clear');
    try {
      return super.clear();
    } finally {
      _$_UnavailableLocationsStoreActionController.endAction(_$actionInfo);

...
mixin _$SubscriptionPurchaseStore on _SubscriptionPurchaseStore, Store {
  late final _$_lastPurchaseAtom =
      Atom(name: '_SubscriptionPurchaseStore._lastPurchase', context: context);
  ...
  late final _$_subscriptionStatusAtom =
      Atom(name: '_SubscriptionPurchaseStore._subscriptionStatus', context: context);
  ...
  late final _$redeemCodeAsyncAction =
      AsyncAction('_SubscriptionPurchaseStore.redeemCode', context: context);
  ...
  late final _$retryVerificationProcessAsyncAction =
      AsyncAction('_SubscriptionPurchaseStore.retryVerificationProcess', context: context);
  ...
  late final _$manageSubscriptionAsyncAction =
      AsyncAction('_SubscriptionPurchaseStore.manageSubscription', context: context);
  ...
  late final _$_onPurchaseUpdateAsyncAction =
      AsyncAction('_SubscriptionPurchaseStore._onPurchaseUpdate', context: context);
  ...
  late final _$_handlePurchaseAsyncAction =
      AsyncAction('_SubscriptionPurchaseStore._handlePurchase', context: context);
  ...
  late final _$_verifyPurchaseAsyncAction =
      AsyncAction('_SubscriptionPurchaseStore._verifyPurchase', context: context);
  ...
  Future<void> _verifyPurchase(
    ...
    return _$_verifyPurchaseAsyncAction.run(() => super._verifyPurchase(
        productId: productId,
        price: price,
        currency: currency,
        duration: duration,
